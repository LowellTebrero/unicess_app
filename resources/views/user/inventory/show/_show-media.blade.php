@foreach ($inventory as $invent )
    ...
    <div class="flex flex-wrap">
              ...
              <div class="p-2">
                  <table class="w-full">
                    ...
                    <tbody>
                        ...
                        @if ($proposals->specialorder->isEmpty())
                        @else
                        ...
                        @if ($proposals->specialorder->isEmpty())
                        @else
                            @foreach ($proposals->specialorder as $travel )
                            @foreach ($travel->medias as $mediaLibrary )
                                <tr class="hover:bg-gray-200 ">
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 flex items-center space-x-2">
                                        <x-alpine-modal>
                        ...
                        @if ($proposals->officeorder->isEmpty())
                        @else
                            @foreach ($proposals->officeorder as $travel )
                            @foreach ($travel->medias as $mediaLibrary )
                                <tr class="hover:bg-gray-200 ">
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 flex items-center space-x-2">
                                        <x-alpine-modal>
                        ...
                        @if ($proposals->attendance->isEmpty())
                        @else
                            @foreach ($proposals->attendance as $travel )
                            @foreach ($travel->medias as $mediaLibrary )
                                <tr class="hover:bg-gray-200 ">
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 flex items-center space-x-2">
                                        <x-alpine-modal>
                        ...
                        @if ($proposals->attendancemonitoring->isEmpty())
                        @else
                            @foreach ($proposals->attendancemonitoring as $travel )
                            @foreach ($travel->medias as $mediaLibrary )
                                <tr class="hover:bg-gray-200 ">
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 flex items-center space-x-2">
                                        <x-alpine-modal>
                        ...
                        @else
                            @foreach ($proposals->narrativereport as $travel )
                            @foreach ($travel->medias as $mediaLibrary )
                                <tr class="hover:bg-gray-200 ">
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 flex items-center space-x-2">
                                        <x-alpine-modal>
                        ...
                        @else
                            @foreach ($proposals->terminalreport as $travel )
                            @foreach ($travel->medias as $mediaLibrary )
                                <tr class="hover:bg-gray-200 ">
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 flex items-center space-x-2">
                                        <x-alpine-modal>
        ...
        <div class="flex py-3 items-center flex-wrap">
            ...
            @if ($proposals->travelorder->isEmpty())
            @else
