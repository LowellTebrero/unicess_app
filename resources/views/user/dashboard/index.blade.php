            ...
            <section class="h-full flex flex-col space-y-4">
                ...
                <div class="h-[15vh] grid grid-cols-2 sm:grid-cols-4 gap-2 mb-10 sm:mb-0">
                    <a href={{ route('User-dashboard.profile') }} class="w-full rounded-lg  hover:from-cyan-300 hover:to-sky-200 bg-gradient-to-tl from-cyan-400 to-sky-300 pt-2 sm:pt-4 md:p-2 xl:px-5 2xl:px-10 2xl:py-9 xl:py-5 flex flex-row px-2 space-x-2 sm:flex-col xl:flex-row lg:pt-3 xl:p-0 items-center">
                        ...
                        @else
                        <img src="{{ asset('/upload/profile.png') }}" class="2xl:w-20 xl:mr-5 2xl:mr-8  xl:w-12 xl:h-12 2xl:h-20 w-12 lg:w-[4rem]">
                        @endif
                        <h1 class="font-thick text-gray-700 tracking-wide xl:text-xs 2xl:text-base lg:text-center text-xs text-center">Your Role
                    ...
                    <div class="w-full rounded-lg bg-gradient-to-tl from-violet-400 to-sky-500 p-2 xl:px-5 xl:py-5 2xl:px-10 2xl:py-5 flex lg:p-2 relative">
                        <div class="flex-1 text-gray-800 flex  flex-col  pl-5 justify-center">
                            <span class=" font-medium text-4xl sm:text-5xl 2xl:text-6xl">{{$counts}}</span>
                    ...
                    <a href={{route('User-dashboard.my-proposal')}} class="relative w-full rounded-lg p-2  hover:from-red-400 hover:to-pink-500  bg-gradient-to-tl from-red-500 to-pink-400 xl:px-5  xl:py-5 2xl:px-10 2xl:py-5 flex">
                        <div class="flex-1 text-gray-800 flex  flex-col  pl-5 justify-center">
                            <span  class=" font-medium text-4xl sm:text-5xl 2xl:text-6xl">{{$second}}</span>
                    ...
                    <a @if ($latestYearPoints == null) href={{ route('evaluate.index') }} @else href={{ route('evaluate.created', $latestYearPoints->id) }} @endif class="relative text-gray-800 w-full rounded-lg hover:from-sky-600 hover:to-sky-500  bg-gradient-to-tl from-sky-500 to-sky-400 xl:px-5  xl:py-5 2xl:px-10 2xl:py-5 flex p-2">
                        <div class="flex-1 text-gray-800 flex  flex-col  pl-5 justify-center">
                            <span  class=" font-medium text-4xl sm:text-5xl 2xl:text-6xl"> @if ($latestYearPoints == null) 0 @else {{ $latestYearPoints->total_points }} @endif</span>
                ...
                <div class="xl:space-y-4 text-gray-700 bg-white h-full rounded-lg ">
