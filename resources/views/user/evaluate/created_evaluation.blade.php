        ...
        @if (Auth::user()->authorize == 'checked')
            ...
            <section class="m-8  rounded-lg text-slate-600 relative mt-4 2xl:mt-5 h-[82vh] bg-white 2xl:h-[87vh]">
                ...
                <header class="flex justify-between p-5 py-4 flex-col sm:flex-row">
                    <h1 class="xl:text-2xl sm:text-lg text-[.9rem] font-semibold tracking-wider text-slate-700">Show Evaluation<button data-tooltip-target="tooltip-right3" data-tooltip-placement="bottom" class="inline-block" type="button"><img src="{{ asset('img/i.png') }}" width="18" alt=""></button></h1>
                ...
                <main class="flex flex-col items-center justify-center w-full p-5 h-[90%] ">
                        ...
                        <div id="div2" class="hidden-div-container hidden-div flex flex-col text-green-500">
                            <div class=" py-2 flex space-x-2 text-green-400 text-lg font-medium items-center justify-between">
                                ...
                                <div class="flex items-end flex-col">
                                    ...
                                    <a href={{ route('evaluate-pdf',$Evaluation->id ) }} class="text-white py-1 px-3 rounded-lg text-xs bg-green-400 hover:bg-green-500">Click here to download pdf</a>
                                </div>
                            </div>
                            @include('user.evaluate.index_filter._filter_userform_index')
                        </div>
