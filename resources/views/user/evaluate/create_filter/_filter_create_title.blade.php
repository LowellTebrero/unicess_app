<div class="flex flex-col items-center">
    ...
    <h1 class="text-xl text-center  pt-4  tracking-wider font-bold "> CES FACULTY PERFORMANCE EVALUATION FORM</h1>
    <div class="pb-4 text-center  font-normal">
        <h1 class="xl:text-sm 2xl:text-normal">Service to University and The Larger Community (maximum of 100 point)</h1>
    </div>
</div>
