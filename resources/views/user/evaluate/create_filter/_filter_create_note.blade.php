...
<p class="pt-2 text-justify font-light text-xs 2xl:text-sm ">
    Note: Covers Extension and Community Services: (a) Extension services refer to activities related to
        ...
        academic work but not necessarily directly in line with one's area of specialization. Such activities should
        be recognized (university consent) and should be supported by valid documents/papers. It should
        answer the question "what benefit can the university derive from one's participation in such activity?"
</p>
