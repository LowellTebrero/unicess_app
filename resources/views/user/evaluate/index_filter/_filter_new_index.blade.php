...
<main class="h-[70vh] p-5 w-full flex items-center justify-center flex-col ">
    ...
    <div class="space-y-3">
                    ...
                    <div class="bg-gradient-to-r from-blue-600 to-blue-500 rounded-lg py-6 px-8 border-2 border-blue-200 w-[50rem] text-white relative">
                        <div class="flex justify-between items-center relative">
                            <div class="space-y-3">
                                ...
                                <div>                                   
                                    <h1 class="text-[1.1rem] tracking-wider font-medium"> 1st Sem {{$currentYear}}-{{ $previousYear }} Evaluation  </h1>
                                    <hr>
                                ...
                                <div>                      
                                    <a href={{ route('evaluate.created', $firstSemesterEvaluations->id) }} class="border text-sm rounded-lg py-1 px-2 hover:bg-white hover:text-blue-500">
                                    Show detail
                                    </a>
                                </div>
                            ...
                            <div>
                                <div class="py-7 px-10  text-center">
                                    <h1 class="2xl:text-7xl text-white font-medium">{{ $firstSemesterEvaluations->total_points }}</h1>
        ...
        @if ($dateNow >= $secondSemesterStart )
            <div class=" flex flex-col space-y-2">
            <h1>2nd Semester SY {{ $currentYear }} - {{ $previousYear }}</h1>
                    ...
                    <div class="bg-gradient-to-r from-blue-600 to-blue-500 rounded-lg py-6 px-8 border-2 border-blue-200 w-[50rem] text-white relative">
                        <div class="flex justify-between items-center relative">
                            <div class="space-y-3">
                                ...
                                <div>                      
                                    <a href={{ route('evaluate.created', $secondSemesterEvaluations->id) }} class="border text-sm rounded-lg py-1 px-2 hover:bg-white hover:text-blue-500">
                                    Show detail
                                    </a>
                                </div>
                            ...
                            <div>
                                <div class="py-7 px-10  text-center">
                                    <h1 class="2xl:text-7xl text-white font-medium">{{ $secondSemesterEvaluations->total_points }}</h1>
                                    <h1 class="text-sm tracking-wider text-white">Total points</h1>
                                </div>                 
                            </div>
                        </div>
