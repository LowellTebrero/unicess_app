    ...
    <section class="flex">
        ...
        <div class="basis-1/3 flex flex-col  items-center h-1/2 ">
            ...
            <div class="relative flex justify-center ">
                ...
                <div class="absolute bottom-0 z-10 2xl:right-[10rem] xl:right-[7rem] bg-blue-500 rounded-full flex items-center justify-center">
                    <button class=" p-1 absolute" type="button">
                        <svg class="fill-white" xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24">
                            <path
                ...
                <div x-cloak x-data="{ 'showModal': false }" @keydown.escape="showModal = false">
                    ...
                    <div class="w-full mt-8">
                        <div class="flex justify-between">
                            <div>
                                <x-input-label class="lg:text-xs inline-block" for="role" :value="__('Your Role')" />
                            ...
                            <div class="w-1/4 py-4 mx-auto text-left bg-white rounded-lg shadow-lg" x-show="showModal"
                                ...
                                transition ease-in-ou m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none">
                                        ...
                                        <div class="mt-4 w-full">
                                            ...
                                            {{--  <div id="partnersId" style="display: none">
                                                <x-input-label onchange="" class="lg:text-xs " :value="__('Partners Name')" />

                                                <select id="partners_id"
                                                    class="greeting lg:text-xs xl:text-sm block mt-1 w-full rounded-md shadow-sm border-gray-300 text-gray-900 "
                                                    type="text" name="partners_id" autofocus
                                                    autocomplete="partners_id">

                                                    @foreach ($partners as $id => $partners_name)
                                                        <option value="{{ $id }}"
                                                            @if ($id == old('partners_id', $user->partners_id)) selected="selected" @endif>
                                                            {{ $partners_name }}</option>
                                                    @endforeach
        ...
        <div class="flex-1 space-y-6 px-10 text-gray-900 ">
            ...
            <form method="post" action="{{ route('profile.partials.update-auth-profile', $user->id) }}"
                ...
                <header>
                    ...
                    <p class=" 2xl:text-sm xl:text-xs text-red-600">
                        {{ __('*required fields ') }}
                    </p>
                </header>
                ...
                <div class="w-full pt-5">
                    <label class="2xl:text-lg xl:text-sm tracking-wider font-medium text-gray-700">Basic
                        Information</label>
                    <hr class="mt-2">
                </div>
                ...
                <div class="flex flex-col my-4">
                    <label
                        class="inline-block font-medium text-gray-900 text-sm tracking-wide xl:text-xs 2xl:text-sm">Complete
                        Name <span class="text-red-600 inline-block">*</span></label>
                    <div class="flex space-x-4">

                        <div class="w-full">
                            <x-text-input id="first_name" name="first_name" type="text"
                                class="mt-1 block  w-full  xl:text-xs 2xl:text-sm" :value="old('first_name', $user->first_name)"
                        ...
                        <div class="w-full">
                            ...
                            <x-text-input id="middle_name" name="middle_name" type="text"
                                class="mt-1 block w-full  xl:text-xs 2xl:text-sm" :value="old('middle_name', $user->middle_name)"
                        ...
                        <div class="w-full">
                            ...
                            <x-text-input id="last_name" name="last_name" type="text"
                                class="mt-1 block w-full  xl:text-xs 2xl:text-sm" :value="old('last_name', $user->last_name)"
                ...
                <div class="flex space-x-4 my-4">
                    <div class="w-full">
                        <label
                            class="inline-block font-medium text-gray-900 text-sm tracking-wide xl:text-xs 2xl:text-sm">Suffix</label>
                        <x-text-input id="suffix" name="suffix" type="text"
                            class="mt-1 block w-full  xl:text-xs 2xl:text-sm" :value="old('suffix', $user->suffix)"
                    ...
                    <div class="w-full">
                        <label
                            class="inline-block font-medium text-gray-900 text-sm tracking-wide xl:text-xs 2xl:text-sm"
                            for="first_name">User Name <span class="text-red-600 inline-block">*</span></label>
                        <x-text-input id="name" name="name" type="text"
                            class="mt-1 block w-full  xl:text-xs 2xl:text-sm" :value="old('name', $user->name)"
                            autocomplete="name" />
                ...
                <div class="flex space-x-4 my-4">
                    <div class="w-full">
                        ...
                        <select id="gender" name="gender"
                            class="mt-1 border-b-2 border-blue-500 block w-full rounded-md shadow-sm   xl:text-xs 2xl:text-sm"
                            autocomplete="gender">
                    ...
                    <div class="w-full">
                        ...
                        <x-text-input id="birth_date" name="birth_date" type="date"
                            class="mt-1 block  w-full  xl:text-xs 2xl:text-sm" :value="old('birth_date', $user->birth_date)"
                ...
                <div class="w-full pt-7">
                    <label class="text-xl font-medium text-gray-700 2xl:text-lg xl:text-sm tracking-wider ">Contact
                        Information</label>
                    <hr class="mt-2">
                </div>


                <div class="flex space-x-12 my-4">
                    <div class="w-full ">
                        <label class="block font-medium text-gray-900 text-sm tracking-wide xl:text-xs 2xl:text-sm"
                            for="email">Email Address</label>

                        <h1 class="mt-3 text-sm inline-block mr-1 xl:text-xs 2xl:text-sm">{{ $user->email }}</h1>
                ...
                <div class="my-4">
                    <label class="inline-block font-medium text-gray-900 text-sm tracking-wide xl:text-xs 2xl:text-sm"
                        for="first_name"> Current Home Address <span
                            class="text-red-600 inline-block">*</span></label>
                    ...
                    <div class="flex space-x-10">
                        <div class="w-full">
                            ...
                            <x-text-input id="province" name="province" type="text"
                                class="mt-1 block w-full  xl:text-xs 2xl:text-sm" :value="old('province', $user->province)"
                        ...
                        <div class="w-full">
                            ...
                            <x-text-input id="city" name="city" type="text"
                                class="mt-1 block w-full  xl:text-xs 2xl:text-sm" :value="old('city', $user->city)"
                        ...
                        <div class="w-full">
                            ...
                            <x-text-input id="barangay" name="barangay" type="text"
                                class="mt-1 block w-full  xl:text-xs 2xl:text-sm" :value="old('barangay', $user->barangay)"
                ...
                <div class="flex space-x-12 my-4">
                    <div class="w-full">
                        ...
                        <x-text-input id="address" name="address" type="text"
                            class="mt-1 block w-full  xl:text-xs 2xl:text-sm" :value="old('address', $user->address)"
                    ...
                    <div class="w-1/4">
                        ...
                        <x-text-input id="zipcode" name="zipcode" type="text"
                            class="mt-1 block w-full  xl:text-xs 2xl:text-sm" :value="old('zipcode', $user->zipcode)"
