<x-alpine-modal>
    ...
    <x-slot name="scripts">
        <h1 class="px-4 py-2 bg-yellow-400  rounded">See details</h1>
    </x-slot>
    ...
    <div class="px-5 w-[50rem]">
            ...
            <div class="flex space-x-4">
                ...
                <div class="mb-4 text-gray-700 w-full">
                    ...
                    <div>
                        @foreach ($proposal->proposal_members as $proposal_mem)
                            @if ($proposal_mem->member_type !== null)
                                    <h1 class="text-[.8rem] py-2">{{ $proposal_mem->member_type }}</h1>
                            @endif
                        @endforeach
                    </div>
                </div>
            ...
            <div class="flex justify-between mt-4">
                <button class="bg-blue-500 px-3  rounded-lg text-white hover:bg-blue-600">Edit</button>
