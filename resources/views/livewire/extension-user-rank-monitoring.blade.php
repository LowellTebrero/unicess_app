...
<div class="">
    ...
    <div class="overflow-x-auto p-2 pt-0 h-[52vh] 2xl:h-[65vh] ">
        <table class="table-auto w-full border-collapse">
            <thead class="text-[.7rem] text-gray-700 uppercase sticky top-0 bg-gray-200 w-full">
                ...
                <tr>
                    ...
                    <th class="p-2 whitespace-nowrap">
                        <div class="font-semibold text-center">Total of Extension Project</div>
                    </th>
                </tr>
                @endif
                ...
                <tr class="hover:bg-gray-100 border ">
                    ...
                    <td class="p-3 whitespace-nowrap text-center">
                        {{-- <a href={{ route('admin.dashboard.edit-proposal', $proposal->id) }}> --}}
                            ...
                            <div class=" text-gray-600 text-[.6rem] xl:text-sm font-medium">
