        ...
        <div class="overflow-x-auto ">
            ...
            <table class="table-auto w-full p-5">
                ...
                <tbody class="text-xs xl:text-xs 2xl:text-sm divide-y divide-gray-100">
                    ...
                    <td class="p-2 whitespace-nowrap">
                        <div class="text-left font-medium text-gray-500 ">{{ Str::limit($proposal->project_title, 70) }}</div>
                    </td>

                    <td class="p-2 whitespace-nowrap flex flex-row justify-center items-center space-x-2">
                        <a href={{ route('admin.dashboard.edit-proposal', $proposal->id) }} class="text-blue-400 mb-1  flex space-x-1 text-right">
