<div class="bg-white shadow-lg rounded-lg  h-[82vh] 2xl:min-h-[87vh] m-8 mt-4 2xl:mt-5 text-gray-700">
        <div class="py-2 flex justify-between items-center 2xl:px-8 px-4">
            ...
            <div class="text-sm flex space-x-2">
                ...
                <!-- Modal toggle -->
                <button data-modal-target="default-modal" data-modal-toggle="default-modal" class="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-xs 2xl:text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">
                Summary
                </button>
                ...
                <div id="default-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                    <div class="relative p-4 w-full max-w-4xl h-[55%] 2xl:h-[40%]">
                        ...
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700 h-full">
                            <!-- Modal header -->
                            <div class="flex items-center justify-between 2xl:p-4 p-2 border-b rounded-t dark:border-gray-600">
