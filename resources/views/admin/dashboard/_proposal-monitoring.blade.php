...
<div class="2xl:w-[25rem] xl:w-[14rem] w-full ">
    ...
    <div class="flex flex-col p-5 mt-3 2xl:mt-8 rounded-lg mr-6 bg-white text-gray-800 2xl:h-[50%] h-[55%]">
        ...
        <div id="default-carousel" class="relative w-full h-[100%]" data-carousel="slide">
            ...
            <div class="relative overflow-hidden rounded-lg h-[100%]">
                ...
                <div class="hidden duration-900 ease-in-out" data-carousel-item>
                  <h1 class="text-sm font-medium tracking-wider text-gray-700 flex justify-center">
                    <svg class="mr-1 animate-scale" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><path fill="#f7b602" d="M4 20q-.825 0-1.412-.587T2 18V6q0-.825.588-1.412T4 4h5.175q.4 0 .763.15t.637.425L12 6h9q.425 0 .713.288T22 7q0 .425-.288.713T21 8H7.85q-1.55 0-2.7.975T4 11.45V18l1.975-6.575q.2-.65.738-1.037T7.9 10h12.9q1.025 0 1.613.813t.312 1.762l-1.8 6q-.2.65-.737 1.038T19 20z"/></svg>
                  ...
                  <div class="flex flex-col items-center justify-center space-y-3 pt-4">
                    ...
                    @foreach ($latestfour as $four )
                        <div class="hover:bg-slate-100 border rounded-lg w-[98%] m-1 shadow p-2 flex space-x-2">
                            ...
                            <h1 class="text-xs">{{ Str::limit($four->project_title, 30) }}</h1>
                        </div>
                    @endforeach
                    @endif
                  </div>
                ...
                <div class="hidden duration-500 ease-in-out" data-carousel-item>
                    <h1 class="text-sm  font-medium tracking-wider text-gray-700 flex justify-center">
                        <svg class="mr-1 animate-scale" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><path fill="#f7b602" d="M8.5 11.5h7v-1h-7zm0-4h7v-1h-7zm10.412 12.437l-3.416-4.43q-.367-.478-.877-.743q-.51-.264-1.119-.264H5V4.615q0-.69.463-1.152Q5.925 3 6.615 3h10.77q.69 0 1.152.463q.463.462.463 1.152v14.77q0 .144-.022.285q-.022.142-.066.267M6.615 21q-.69 0-1.152-.462Q5 20.075 5 19.385V15.5h8.5q.365 0 .674.16q.309.161.536.457l3.527 4.616q-.183.127-.398.197q-.214.07-.454.07z"/></svg>
                  ...
                  <div class="flex flex-col items-center justify-center space-y-3 pt-4">
                    ...
                    @foreach ($latestfourfile as $four )
                        <div class="hover:bg-slate-100 border rounded-lg w-[98%] shadow p-2 flex space-x-2">
                            ...
                            @endif
                            <h1 class="text-xs">{{ Str::limit($four->file_name, 25) }}</h1>
                        </div>
                    @endforeach
                    @endif
                  </div>
                ...
                <div class="hidden duration-500 ease-in-out" data-carousel-item>
                    <h1 class="text-sm font-medium tracking-wider text-gray-700 flex justify-center">
                        <svg class="mr-1 animate-scale" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><path fill="#f7b602" d="M12 2A10 10 0 0 0 2 12a10 10 0 0 0 10 10a10 10 0 0 0 10-10A10 10 0 0 0 12 2M7 9.5C7 8.7 7.7 8 8.5 8s1.5.7 1.5 1.5S9.3 11 8.5 11S7 10.3 7 9.5m5 7.73c-1.75 0-3.29-.73-4.19-1.81L9.23 14c.45.72 1.52 1.23 2.77 1.23s2.32-.51 2.77-1.23l1.42 1.42c-.9 1.08-2.44 1.81-4.19 1.81M15.5 11c-.8 0-1.5-.7-1.5-1.5S14.7 8 15.5 8s1.5.7 1.5 1.5s-.7 1.5-1.5 1.5"/></svg>
                    ...
                    <div class="flex flex-col items-center justify-center space-y-3 pt-4">
                      @foreach ($latestfouruser as $four )
                          <div class="hover:bg-slate-100 border rounded-lg w-[98%] shadow p-2 flex space-x-2">
                            ...
                            @endif
                              <h1 class="text-xs">{{ Str::limit($four->email, 30) }}</h1>
                          </div>
                      @endforeach
                    </div>
                    @endif
                ...
                <div class="hidden duration-500 ease-in-out" data-carousel-item>
                    <h1 class="text-sm font-medium tracking-wider text-gray-700 flex justify-center">
                        <svg class="mr-1 animate-scale" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 1024 1024"><path fill="#f7b602" d="M160 894c0 17.7 14.3 32 32 32h286V550H160zm386 32h286c17.7 0 32-14.3 32-32V550H546zm334-616H732.4c13.6-21.4 21.6-46.8 21.6-74c0-76.1-61.9-138-138-138c-41.4 0-78.7 18.4-104 47.4c-25.3-29-62.6-47.4-104-47.4c-76.1 0-138 61.9-138 138c0 27.2 7.9 52.6 21.6 74H144c-17.7 0-32 14.3-32 32v140h366V310h68v172h366V342c0-17.7-14.3-32-32-32m-402-4h-70c-38.6 0-70-31.4-70-70s31.4-70 70-70s70 31.4 70 70zm138 0h-70v-70c0-38.6 31.4-70 70-70s70 31.4 70 70s-31.4 70-70 70"/></svg>
                ...
                <!-- Item 5 -->
                <div class="hidden duration-500 ease-in-out" data-carousel-item>
                    <h1 class="text-sm text-center font-medium tracking-wider text-gray-700 flex justify-center">
                        <svg class="mr-1 animate-scale" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><path fill="#ffbb00" d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2L9.19 8.63L2 9.24l5.46 4.73L5.82 21z"/></svg>
            ...
            <div class="absolute z-30 flex -translate-x-1/2 bottom-5 left-1/2 space-x-3 rtl:space-x-reverse">
                <button type="button" class="w-3 h-3 rounded-full bg-gray-300 hover:bg-gray-500" aria-current="true" aria-label="Slide 1" data-carousel-slide-to="0"></button>
                <button type="button" class="w-3 h-3 rounded-full bg-gray-300 hover:bg-gray-500" aria-current="false" aria-label="Slide 2" data-carousel-slide-to="1"></button>
                <button type="button" class="w-3 h-3 rounded-full bg-gray-300 hover:bg-gray-500" aria-current="false" aria-label="Slide 3" data-carousel-slide-to="2"></button>
                <button type="button" class="w-3 h-3 rounded-full bg-gray-300 hover:bg-gray-500" aria-current="false" aria-label="Slide 4" data-carousel-slide-to="3"></button>
                <button type="button" class="w-3 h-3 rounded-full bg-gray-300 hover:bg-gray-500" aria-current="false" aria-label="Slide 5" data-carousel-slide-to="4"></button>
            </div>
            <!-- Slider controls -->
