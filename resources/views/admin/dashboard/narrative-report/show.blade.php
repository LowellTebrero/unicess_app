<x-admin-layout>
    ...
    @section('title', 'Show Narrative | ' . config('app.name', 'UniCESS'))
    @php
    ...
    <section class="text-gray-700 h-[82vh] 2xl:min-h-[87vh] m-8 mt-5  bg-white rounded-xl shadow">
        ...
        <header class="flex justify-between p-5 py-4">
            <div>
                <h1 class="tracking-wider 2xl:text-2xl font-semibold text-lg">Show Narrative User </h1>
            </div>
            <a href={{ route('admin.dashboard.narrative-index') }}>
                ...
                <table class="table-auto relative w-full">
                    ...
                    <tbody class="text-xs divide-y divide-gray-100 ">
                        ...
                        <tr class="hover:bg-gray-100">
                            ...
                            <button data-modal-target="default-modal{{ $narrative->id }}" data-modal-toggle="default-modal{{ $narrative->id }}" class="text-left text-xs py-2.5" type="button">
                                ...
                                <button data-modal-target="default-modal{{ $narrative->id }}" data-modal-toggle="default-modal{{ $narrative->id }}" class="text-left text-xs py-2.5" type="button">
                                    <div class="flex items-center">
                                        ...
                                        <div class=" text-gray-600 text-[.7rem]">
                                            ...
                                            <h1 class="text-xs tracking-wider">{{ $narrative->users->email }}</h1>
                                        </div>
                                    </div>
                                    </button>
                            ...
                            <td class="p-3 whitespace-nowrap text-left">
                                @foreach ($narrative->users->proposals as $user)
                                @if ($user->proposal_id == $narrative->proposal_id)
                            ...
                            <!-- Main modal -->
                            <div id="default-modal{{ $narrative->id }}" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                    ...
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        ...
                                        <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                                            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                                                {{Str::limit($narrative->proposals->project_title, 80)}}
                                            </h3>
                                            <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="default-modal{{ $narrative->id }}">
