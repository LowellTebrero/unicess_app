<section class="grid grid-cols-3 gap-4 h-[15vh]">
    ...
    <div class="hover:border hover:border-teal-300 bg-white w-full text-gray-600 rounded-lg xl:rounded-xl  hover:bg-slate-100 transition-all flex justify-between items-center p-4 sm:p-0 sm:px-4 md:px-6 px-8 xl:px-10 shadow relative"
        ...
        <svg class="xl:w-[2rem] 2xl:w-[5rem] lg:w-[2rem] w-[1.5rem] sm:absolute sm:top-2 sm:right-5 xl:absolute xl:top-2 xl:right-7 2xl:sticky top-2" xmlns="http://www.w3.org/2000/svg" width="55" height="55" viewBox="0 0 24 24">
