<section class="flex min-h-[15vh] rounded-xl w-full flex-col space-y-4 lg:flex-row  xl:flex-row lg:space-x-6 lg:space-y-0 xl:space-x-5 2xl:space-x-8 mt-5 text-white sm:flex-col md:flex-col md:space-x-0 md:space-y-4 sm:space-y-4 sm:w-full">

    <div class="bg-white w-full text-gray-700 rounded-xl hover:bg-slate-100 transition-all flex justify-between items-center px-10 shadow relative">
        <div class="">
            <span class="block  xl:text-5xl 2xl:text-6xl  font-medium">{{ $totalAccount }}</span>
            <h1 class="xl:text-[.7rem] 2xl:text-sm">Total Account User </h1>
        </div>
        <svg class="xl:w-[2rem] 2xl:w-[5rem] xl:absolute xl:top-2 xl:right-7 2xl:sticky" xmlns="http://www.w3.org/2000/svg" width="55" height="55"
            viewBox="0 0 256 256">
    ...
    <div class="bg-white w-full text-gray-700 rounded-xl  hover:bg-slate-100 transition-all flex justify-between items-center px-10 shadow relative"
        type="button" x-data="{}" x-on:click="window.livewire.emitTo('pending-user', 'show')">
            ...
            <div class="relative">
                <span class="block xl:text-5xl 2xl:text-6xl font-medium">{{ $pendingAccount }}</span>
                <h1 class="xl:text-[.7rem] 2xl:text-sm">Pending account</h1>
        ...
        <svg class="xl:w-[2rem] 2xl:w-[5rem] xl:absolute xl:top-2 xl:right-7 2xl:sticky" xmlns="http://www.w3.org/2000/svg" width="55" height="55" viewBox="0 0 24 24">
            <path fill="currentColor"
    ...
    <a href="{{ route('admin.chart.index') }}"
        class="bg-white w-full text-gray-700 rounded-xl  hover:bg-slate-100 transition-all flex justify-between items-center px-10 shadow relative">

        <div class="relative">
            <span class="block xl:text-5xl 2xl:text-6xl  font-medium">{{ $totalProposal }}</span>
            <h1 class="xl:text-[.7rem] 2xl:text-sm">Total of proposals</h1>
            <div class=" absolute right-5 top-2  flex flex-col">
        ...
        <svg class="xl:w-[1.8rem] 2xl:w-[5rem] xl:absolute xl:top-2 xl:right-7 2xl:sticky" xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 24 24">
            <path fill="currentColor"
