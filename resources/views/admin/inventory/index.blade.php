    ...
    <section class="rounded-xl bg-white h-full">
        ...
        <header class="p-4 py-2 flex justify-between">
            <div class="flex space-x-1 items-center">
                <h1 class="2xl:text-2xl font-semibold text-gray-700 tracking-wider text-sm sm:text-lg">Inventory Section</h1>
                <h1 class="text-[.5rem] sm:text-sm md:text-md">
            ...
            @if ($invent->number == 1)
                ...
                @else
                    <div class="grid 2xl:grid-cols-4 gap-3 p-4 pt-7">
                        ...
                        <span class="text-xs">{{ $name->program_name}}</span>
                        </a>
