        ...
        <header class="p-4 py-2 flex justify-between">
            ...
            <div class="flex space-x-4 items-center">
                <div>
                    ...
                    {{--  <a href={{ route('admin.inventory.backup-project') }} class="text-xs bg-blue-500 hover:bg-blue-600 text-white  rounded-xl px-3 p-2 flex space-x-4 items-center">Back up Project
                ...
                <button data-modal-target="popup-modal" data-modal-toggle="popup-modal" class="text-xs bg-blue-500 hover:bg-blue-600 text-white  rounded-xl px-3 p-2 flex space-x-4 items-center" type="button">
                    Back up Projects
                    <svg class="ml-2" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M12 2v8m4-4l-4 4l-4-4"/><rect width="20" height="8" x="2" y="14" rx="2"/><path d="M6 18h.01M10 18h.01"/></g></svg>
                </button>
                @endif
