...
<div class="relative shadow-md sm:rounded-lg w-full overflow-x-auto 2xl:h-[70vh] h-[60vh]">
    <table class="w-full text-sm text-left text-gray-500 ">
        ...
        <tbody>
                    ...
                    <tr class="bg-white border-b  hover:bg-gray-50 ">
                        ...
                        <td class="px-6 py-4 relative">
                            ...
                            <x-tooltip-modal>
                                ...
                                <a href={{ url('downloads-pdf', $travel->id) }} class="block text-xs px-2 py-2 hover:text-black" x-data="{dropdownMenu: false}">Download</a>
                                <form action="{{ route('admin.inventory.delete-media', $mediaLibrary->id) }}" method="POST" enctype="multipart/form-data" onsubmit="return confirm ('Are you sure?')" >
                                    @csrf
                                    @method('DELETE')
                                <button class="block text-slate-800 text-xs px-2 hover:text-black" type="submit">
                    ...
                    <tr class="bg-white border-b  hover:bg-gray-50 ">
                        ...
                        <td class="px-6 py-4 relative">
                            ...
                            <x-tooltip-modal>
                                ...
                                <a href={{ url('downloads-pdf', $office->id) }} class="block text-xs px-2 py-2 hover:text-black" x-data="{dropdownMenu: false}">Download</a>
                                <form action="{{ route('admin.inventory.delete-media', $mediaLibrary->id) }}" method="POST" enctype="multipart/form-data" onsubmit="return confirm ('Are you sure?')" >
                                    @csrf
                                    @method('DELETE')
                                <button class="block text-slate-800 text-xs px-2 hover:text-black" type="submit">
                    ...
                    <tr class="bg-white border-b  hover:bg-gray-50 ">
                        ...
                        <td class="px-6 py-4 relative">
                            ...
                            <x-tooltip-modal>
                                ...
                                <a href={{ url('downloads-pdf', $special->id) }} class="block text-xs px-2 py-2 hover:text-black" x-data="{dropdownMenu: false}">Download</a>
                                <form action="{{ route('admin.inventory.delete-media', $mediaLibrary->id) }}" method="POST" enctype="multipart/form-data" onsubmit="return confirm ('Are you sure?')" >
                                    @csrf
                                    @method('DELETE')
                                <button class="block text-slate-800 text-xs px-2 hover:text-black" type="submit">
                    ...
                    <tr class="bg-white border-b  hover:bg-gray-50 ">
                        ...
                        <td class="px-6 py-4 relative">
                            ...
                            <x-tooltip-modal>
                                ...
                                <a href={{ url('downloads-pdf', $attend->id) }} class="block text-xs px-2 py-2 hover:text-black" x-data="{dropdownMenu: false}">Download</a>
                                <form action="{{ route('admin.inventory.delete-media', $mediaLibrary->id) }}" method="POST" enctype="multipart/form-data" onsubmit="return confirm ('Are you sure?')" >
                                    @csrf
                                    @method('DELETE')
                                <button class="block text-slate-800 text-xs px-2 hover:text-black" type="submit">
            ...
            @foreach ($proposals->attendancemonitoring as $attendancem )
                    ...
                    <tr class="bg-white border-b  hover:bg-gray-50 ">
                        ...
                        <td class="px-6 py-4 relative">
                            ...
                            <x-tooltip-modal>
                                ...
                                <a href={{ url('downloads-pdf', $attendancem->id) }} class="block text-xs px-2 py-2 hover:text-black" x-data="{dropdownMenu: false}">Download</a>
                                <form action="{{ route('admin.inventory.delete-media', $mediaLibrary->id) }}" method="POST" enctype="multipart/form-data" onsubmit="return confirm ('Are you sure?')" >
                                    @csrf
                                    @method('DELETE')
                                <button class="block text-slate-800 text-xs px-2 hover:text-black" type="submit">
