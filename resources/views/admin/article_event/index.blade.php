...
<x-admin-layout>
    ...
    <section class="bg-white h-full rounded-xl shadow text-gray-700">
        ...
        <div id="article-content" class="tab-content bg-white shadow p-2 m-5 mt-0 rounded-lg border h-[75%]" style="display: none;">
        ...
        <div id="event-content" class="tab-content bg-white shadow p-2 m-5 mt-0 rounded-lg border h-[75%]" style="display: none;">
            <div class="flex justify-between mb-2">
        ...
        <div id="partner-content" class="tab-content bg-white shadow p-2 m-5 mt-0 rounded-lg border h-[75%]" style="display: none;">
            <div class="flex justify-between mb-2">
        ...
        <div id="beneficiary-content" class="tab-content bg-white shadow p-2 m-5 mt-0 rounded-lg border h-[75%]" style="display: none;">
            <div class="flex justify-between mb-2">
        ...
        <div id="program-and-services-content" class="tab-content bg-white shadow p-2 m-5 mt-0 rounded-lg border h-[75%]" style="display: none;">
