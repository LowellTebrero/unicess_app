@auth
    @php
        ...
        if($notifications){
            auth()->user()->unreadNotifications->where('id', $notifications)->markAsRead();
        }
            ...
            $('#evaluate-link').click(function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        // After the AJAX request is sent and notifications are marked as read,
                        // navigate to the destination URL
                        window.location.href = $('#evaluate-link').attr('href');
                    },
