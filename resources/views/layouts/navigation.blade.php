                    ...
                    <div class="flex">
                        ...
                        @unlessrole('admin')
                            <div class="relative" x-data="{ open: false }" @click.outside="open = false"
                                ...
                                <div @click="open = ! open">
                                    <button class="mt-2 sm:mt-4 relative ">
                                        @if ($notifs > 0)
                                            <h1
                                                class="text-red-500 text-[.2rem] rounded-full  px-1 pt-1 font-semibold absolute z-10 right-0 top-2 bg-red-500">
                                                {{ $notifs }}</h1>
                        ...
                        <div class="hidden sm:flex sm:items-center  ml-2 md:ml-4 sm:mr-4 md:mr-7">
        ...
        <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden ">
            ...
            <div class="pt-4 pb-1 border-t border-gray-200">
                ...
                <div class="flex-wrap px-4">
                   ...
                   <x-nav-link :href="route('profile.partials.edit-auth-profile', $user->id)" class="text-white text-xs xl:text-sm ">
                       {{ __('Profile') }}
                    </x-nav-link>
                   ...
                   <form method="POST" action="{{ route('logout') }}">
                       @csrf
                       <x-nav-link :href="route('logout')" class="text-white text-xs xl:text-sm "
                           onclick="event.preventDefault();
                                       this.closest('form').submit();">
                           {{ __('Log Out') }}
                        </x-nav-link>
